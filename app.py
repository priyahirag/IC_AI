...
if st.button(
    ...
    # --------------------------------------
    # Pick a random YOLO profile
    # --------------------------------------

    selected_yolo = random.choice(
        YOLO_PROFILES
    )
    ...
    evidence_options = [
        ...
        "Heavy flooding reported, people affected",

        "Floodwater has covered the main road and vehicles are unable to move",

        "Floodwater is affecting the area and boats are being used for movement"

    ]

    new_evidence = random.choice(
        evidence_options
    )


    # --------------------------------------
    # Calculate base urgency from evidence
    # --------------------------------------

    new_base_urgency = calculate_urgency(
        new_evidence
    )
